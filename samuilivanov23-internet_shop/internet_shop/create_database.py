...
def createTables(cur, connection):    
    ...
    CREATE TABLE IF NOT EXISTS charts_products(
        "chart_id" bigserial,
    ...
    ALTER TABLE charts_products ADD FOREIGN KEY (chart_id) REFERENCES charts (id);

    ALTER TABLE charts_products ADD FOREIGN KEY (product_id) REFERENCES products (id);

    ALTER TABLE tags_products ADD FOREIGN KEY (tag_id) REFERENCES charts (id);
